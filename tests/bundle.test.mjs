...
test('сборка сохраняет идентификатор счётчика без сетевого скрипта', () => {
    ...
    assert.doesNotMatch(bundle, /src="\/pulse\/script\.js"/,
        'offline bundle не должен подключать сетевой счётчик');
});
