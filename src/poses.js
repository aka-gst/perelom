...
export const POSES = {
    idle: {
        ...
        elbowF: [18, 38], handF: [24, 56], elbowB: [-14, 38], handB: [-4, 54],
        kneeF: [20, -38], footF: [30, -78], kneeB: [-18, -40], footB: [-32, -78],
    },
    guard: {
        pelvis: [0, -4], chest: [-1, 26], neck: [0, 48], head: [2, 66],
        elbowF: [14, 34], handF: [18, 52], elbowB: [-12, 34], handB: [4, 48],
        kneeF: [18, -40], footF: [28, -78], kneeB: [-20, -40], footB: [-34, -78],
    },
    catch: {
        pelvis: [2, -2], chest: [4, 28], neck: [6, 50], head: [12, 66],
        elbowF: [26, 40], handF: [44, 44], elbowB: [-8, 38], handB: [0, 52],
        kneeF: [22, -38], footF: [32, -78], kneeB: [-16, -40], footB: [-30, -78],
    },
    windHand: {
        pelvis: [-2, 0], chest: [-4, 29], neck: [-4, 51], head: [-2, 69],
        elbowF: [10, 36], handF: [-4, 44], elbowB: [-16, 38], handB: [-6, 52],
        kneeF: [18, -38], footF: [28, -78], kneeB: [-20, -40], footB: [-34, -78],
    },
    hitHand: {
        pelvis: [4, -2], chest: [8, 28], neck: [10, 50], head: [14, 66],
        elbowF: [30, 44], handF: [48, 40], elbowB: [-8, 40], handB: [-16, 28],
        kneeF: [26, -38], footF: [36, -78], kneeB: [-14, -42], footB: [-30, -78],
    },
    windFoot: {
        pelvis: [-2, 2], chest: [-2, 32], neck: [-2, 54], head: [2, 72],
        elbowF: [14, 40], handF: [20, 56], elbowB: [-16, 40], handB: [-6, 54],
        kneeF: [40, 4], footF: [22, -30], kneeB: [-14, -40], footB: [-26, -78],
    },
    hitFoot: {
        pelvis: [-4, -4], chest: [-8, 26], neck: [-10, 48], head: [-8, 66],
        elbowF: [6, 36], handF: [16, 50], elbowB: [-26, 40], handB: [-34, 26],
        kneeF: [34, 0], footF: [72, 4], kneeB: [-18, -42], footB: [-32, -78],
    },
    windGrab: {
        pelvis: [-2, 0], chest: [-2, 30], neck: [-2, 52], head: [0, 70],
        elbowF: [14, 40], handF: [4, 52], elbowB: [-16, 40], handB: [-4, 50],
        kneeF: [18, -40], footF: [28, -78], kneeB: [-18, -40], footB: [-32, -78],
    },
    hitGrab: {
        pelvis: [6, -4], chest: [10, 26], neck: [12, 48], head: [16, 64],
        elbowF: [30, 42], handF: [48, 38], elbowB: [28, 40], handB: [46, 34],
        kneeF: [28, -40], footF: [38, -78], kneeB: [-8, -42], footB: [-24, -78],
    },
    hurt: {
        pelvis: [-6, -4], chest: [-12, 26], neck: [-16, 46], head: [-24, 60],
        elbowF: [2, 36], handF: [-6, 50], elbowB: [-30, 38], handB: [-40, 26],
        kneeF: [10, -40], footF: [22, -78], kneeB: [-24, -42], footB: [-38, -78],
    },
    getup: {
        pelvis: [0, -34], chest: [4, -6], neck: [6, 14], head: [12, 30],
        elbowF: [22, 0], handF: [34, 12], elbowB: [-10, -2], handB: [-4, 12],
        kneeF: [40, -52], footF: [12, -78], kneeB: [-38, -54], footB: [-14, -78],
    },
};
