...
export const BONES = {
    arm: {
        ...
        name: 'РУКА',
        /**
         * Импульс, который кость держит.
         *
         * Числа выросли, когда бой стал реальным: раньше удар всегда бил в
         * кость из таблицы, а теперь попадает туда, куда пришёлся. Кость
         * обязана держать один обычный удар — иначе переломы идут каждый
         * размен и перестают быть событием. Ломают накопленный импульс,
         * встречный удар и земля.
         */
        strength: 620,
